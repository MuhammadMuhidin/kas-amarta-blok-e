...
export function SettingRow({ title, description, checked, disabled, onChange }) {
  return (
...
export function SelectRow({ title, description, value, options, disabled, isMobile, onChange }) {
  return (
    <div style={{ ...styles.row, ...(isMobile ? styles.rowMobile : {}) }}>
      ...
      <select
        ...
        style={{ ...styles.selectInput, ...(isMobile ? styles.inputMobile : {}) }}
      >
        {options.map((option) => (
  ...
  return (
    <div style={{ ...styles.row, ...(isMobile ? styles.rowMobile : {}) }}>
      ...
      <div style={{ ...styles.configAction, ...(isMobile ? styles.configActionMobile : {}) }}>
        ...
        >
          <LoadingButtonContent loading={saving && !unchanged} loadingText="Saving...">
            Save
...
export const styles = {
  ...
  title: { margin: "0 0 18px", fontSize: 20 },
  ...
  themeIntro: { marginBottom: 14, color: "var(--admin-muted)", fontSize: 13 },
  themeGrid: {
    display: "grid",
  ...
  slider: { position: "absolute", inset: 0, borderRadius: 999, transition: ".2s" },
  knob: {
    position: "absolute",
    top: 4,
    left: 4,
  ...
  selectInput: { width: 190, maxWidth: "100%", boxSizing: "border-box" },
  inputMobile: { width: "100%", maxWidth: "100%", boxSizing: "border-box" },
  configAction: {
    display: "flex",
    alignItems: "center",
    gap: 10,
  ...
  saveButtonMobile: { width: "100%", maxWidth: "100%", boxSizing: "border-box" },
  pinTitle: { fontSize: 20, fontWeight: 800, marginBottom: 8 },
  pinDesc: { fontSize: 13, color: "var(--admin-muted)", marginBottom: 14 },
  pinInput: {
    width: "100%",
    boxSizing: "border-box",
    padding: "12px 14px",
