...
export const RATE_LIMIT_SCOPES = {
  ...
  adminLoginOtpRequest: "admin_login_otp_request",
  webauthVerifyFailed: "webauth_verify_failed",
  settingsUpdate: "settings_update",
  profileCredentialUpdate: "profile_credential_update",
...
export const RATE_LIMIT_RULES = {
  ...
  [RATE_LIMIT_SCOPES.adminLoginOtpRequest]: {
    limit: 3,
    windowSeconds: 60,
  ...
  [RATE_LIMIT_SCOPES.profileCredentialUpdate]: {
    limit: 5,
    windowSeconds: 15 * 60,
    message: "Terlalu banyak perubahan credential. Silakan coba lagi nanti.",
  },
