...
export function validatePaymentProofFile(file) {
  validateUploadedFile(file, {
    requiredMessage: "Bukti transfer wajib dilampirkan",
    maxSizeMessage: "Ukuran bukti transfer maksimal 5MB",
    typeMessage: "Format bukti transfer harus JPG, PNG, WEBP, atau PDF",
    allowedTypes: ["image/jpeg", "image/png", "image/webp", "application/pdf"],
  });
}
