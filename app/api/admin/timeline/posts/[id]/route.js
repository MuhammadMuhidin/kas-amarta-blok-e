...
import {
  deleteTimelinePostById,
  updateTimelinePostFromBody,
...
export async function PATCH(req, { params }) {
  try {
    ...
    const result = await updateTimelinePostFromBody(params.id, body);
...
export async function DELETE(req, { params }) {
  try {
    ...
    const result = await deleteTimelinePostById(params.id);
