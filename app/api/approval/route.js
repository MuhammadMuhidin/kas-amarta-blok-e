...
export async function GET(req) {
  try {
    ...
    return NextResponse.json({ error: err.message || "Gagal membaca data pengajuan" }, { status: 500 });
  }
}
...
export async function POST(req) {
  try {
    ...
    return NextResponse.json({ error: err.message || "Gagal membuat pengajuan" }, { status: 500 });
  }
}
